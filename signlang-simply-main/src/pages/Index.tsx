    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Bridgely helps you learn sign language through interactive 3D
                models and real-world video tutorials at your own pace. Start
                your journey towards better communication today.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="section-subheading">
              Our platform combines cutting-edge technology with effective
              learning methods to make sign language accessible to everyone.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Learn sign language with immersive 3D animations that show precise hand movements from any angle.",
              },
              {
                icon: <Video className="w-6 h-6 text-primary" />,
                title: "Video Tutorials",
                description:
                  "Watch high-quality videos featuring experienced signers demonstrating signs and phrases in real-world contexts.",
              },
              {
                icon: <Globe className="w-6 h-6 text-primary" />,
                title: "Comprehensive Library",
                description:
                  "Access a growing library of signs covering alphabets, common words, phrases, and everyday conversations.",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Keep track of your learning journey with our intuitive progress system that celebrates your achievements.",
              },
              {
                icon: <Heart className="w-6 h-6 text-primary" />,
                title: "Inclusive Design",
                description:
                  "Designed with accessibility in mind to ensure everyone can learn sign language effectively.",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/90 to-primary overflow-hidden text-white">
        ...
        <div className="max-w-3xl mx-auto relative z-10 text-center">
          ...
          >
            Breaking communication barriers begins with a single step. Choose
            your preferred learning method and embark on your journey to fluency
            in sign language.
          </motion.p>
          <motion.div
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="section-subheading">
              Bridgely is helping people around the world connect through sign
              language
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-right">
            <p className="text-gray-600 text-sm">
              © {new Date().getFullYear()} Bridgely. Breaking barriers through
              sign language.
            </p>
          </div>
        </div>
